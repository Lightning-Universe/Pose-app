...
class FiftyOneBuildConfig(L.BuildConfig):
  def build_commands(self) -> List[str]:
    return [
      ...
      f". ~/{lightning_pose_venv}/activate;python -m pip install --extra-index-url https://developer.download.nvidia.com/compute/redist --upgrade nvidia-dali-cuda102; deactivate",
