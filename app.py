...
from lai_components.select_fo_dataset import SelectDatasetUI
...
# data.data_dir=./lightning_pose/toy_datasets/toymouseRunningData 
# Saved predictions to: pred_csv_files_to_plot=/home/jovyan/lightning_pose-app/lightning_pose/outputs/2022-05-15/16-06-45/predictions.csv
#             pred_csv_files_to_plot=["./lightning_pose/outputs/2022-05-15/16-06-45/predictions.csv"]  
#            test_videos_directory="./lightning_pose/toy_datasets/toymouseRunningData/unlabeled_videos" \##
#            saved_vid_preds_dir="./lightning_pose/toy_datasets/toymouseRunningData" \
#            video_file_to_plot="./lightning_pose/toy_datasets/toymouseRunningData/unlabeled_videos/test_vid.mp4" \
...
class LitPoseApp(L.LightningFlow):
    def __init__(self):
        ...
        self.config_ui = ConfigUI(
          script_dir = "./lightning_pose",
          script_env = "HYDRA_FULL_ERROR=1",
          config_dir = "./lightning_pose/scripts/configs",
          config_ext = "*.yaml",        
          eval_test_videos_directory = "./lightning_pose/toy_datasets/toymouseRunningData/unlabeled_videos",     
        )
...
""",
        ...
        self.fo_ui = FoRunUI(
          ...
          script_env = "HYDRA_FULL_ERROR=1",
          config_dir = "./lightning_pose/scripts",
...
eval.video_file_to_plot=./lightning_pose/toy_datasets/toymouseRunningData/unlabeled_videos/test_vid.mp4
"""  
        )   

        self.my_work = LitBashWork(cloud_compute=L.CloudCompute("cpu-medium"))
    ...
    def run(self):
      ...
      if self.train_ui.run_script == True:      
        ...
        self.my_work.run(cmd,
          env=self.train_ui.form_values["script_env"],
          cwd = self.train_ui.form_values["script_dir"], 
          )  
        # predict  
      ...
      if self.fo_ui.run_script == True:      
        ...
        cmd = "python " + "scripts/create_fiftyone_dataset.py" + " " + f"{self.fo_ui.st_script_args} eval.fiftyone.dataset_to_create=images {self.fo_names} {self.fo_launch}"
        self.my_work.run(cmd,
        ...
        cmd = "python " + "scripts/create_fiftyone_dataset.py" + " " + f"{self.fo_ui.st_script_args} eval.fiftyone.dataset_to_create=videos {self.fo_names} {self.fo_launch}"
        self.my_work.run(cmd,
          env=self.fo_ui.st_script_env,
          cwd = self.fo_ui.st_script_dir, 
          )
