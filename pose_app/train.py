...
class TrainScript(TracerPythonScript):
...
def _render_streamlit_fn(state: AppState):
    ...
    st_config_ext = st.text_input(
        "Config File Extensions", value=state.config_ext or "*.yaml"
    )

    st_script_arg = st.text_area("Script Args", value="training.max_epochs=11 model.losses_to_use=[] data.data_dir=/home/jovyan/lightning-pose/toy_datasets/toymouseRunningData" , placeholder="training.max_epochs=11")
