    ...
    def run(self):
        ...
        if self.extract_ui.proj_dir and self.extract_ui.run_script_video_random:
            ...
            if self.extract_ui.work_is_done_extract_frames:
                ...
                # hack, for some reason app won't advance past ls run
